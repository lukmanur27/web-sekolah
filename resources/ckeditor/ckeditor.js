(function() {
                ...
                domReady: function() {
                    ...
                    return function(b) {
                        ...
                        if (1 == c.length)
                            ...
                            b = !1;
                            try { b = !window.frameElement } catch (h) {}
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) { var d = CKEDITOR.event.prototype,
        ...
        return {
            ...
            on: function(b, d, h, k, g) {
                function l(a, x, t, e) { a = { name: b, sender: this, editor: a, data: x, listenerData: k, stop: t, cancel: e, removeListener: u }; return !1 === d.call(h, a) ? !1 : a.data }

                function u() { x.removeListener(b, d) } var e = a.call(this, b); if (0 > e.getListenerIndex(d)) { e = e.listeners;
                    h || (h = this);
                    isNaN(g) && (g = 10); var x = this;
                    l.fn = d;
                    l.priority = g; for (var t = e.length - 1; 0 <= t; t--)
                        if (e[t].priority <= g) return e.splice(t + 1, 0, l), { removeListener: u };
                    e.unshift(l) } return { removeListener: u } },
    ...
    CKEDITOR.on("log", function(a) { if (window.console && window.console.log) { var d = console[a.data.type] ? a.data.type : "log",
            ...
            console[d]("[CKEDITOR] For more information about this error go to https://ckeditor.com/docs/ckeditor4/latest/guide/dev_errors.html#" + b) } }, null, null, 999);
    CKEDITOR.dom = {};
    (function() {
        function a(a, b, e) { this._minInterval = a;
            this._context = e;
            this._lastOutput = this._scheduledTimer = 0;
            this._output = CKEDITOR.tools.bind(b, e || {}); var c = this;
            this.input = function() {
                function a() { c._lastOutput = (new Date).getTime();
                    c._scheduledTimer = 0;
                    c._call() } if (!c._scheduledTimer || !1 !== c._reschedule()) { var x = (new Date).getTime() - c._lastOutput;
        ...
        function d(x, b, e) {
            ...
            this.input = CKEDITOR.tools.override(this.input,
                function(a) { return function() { c._args = Array.prototype.slice.call(arguments);
                        a.call(this) } })
        }
        var b = [],
            ...
            u = { lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­" },
            e = function(a, b) { return "#" == b[0] ? String.fromCharCode(parseInt(b.slice(1), 10)) : u[b] };
        ...
        CKEDITOR.tools = {
            ...
            getIndex: function(a, b) { for (var e = 0; e < a.length; ++e)
                    if (b(a[e])) return e;
                return -1 },
            clone: function(a) {
                var b;
                if (a && a instanceof Array) { b = []; for (var e = 0; e < a.length; e++) b[e] = CKEDITOR.tools.clone(a[e]); return b }
            ...
            extend: function(a) { var b = arguments.length,
                    e, c; "boolean" == typeof(e = arguments[b - 1]) ? b-- : "boolean" == typeof(e = arguments[b - 2]) && (c = arguments[b - 1], b -= 2); for (var g = 1; g < b; g++) { var m = arguments[g] || {};
                    CKEDITOR.tools.array.forEach(CKEDITOR.tools.object.keys(m), function(b) { if (!0 === e || null == a[b])
                            if (!c || b in c) a[b] = m[b] }) } return a },
            ...
            buildStyleHtml: function(a) { a = [].concat(a); for (var b, e = [], c = 0; c < a.length; c++)
            ...
            transformPlainTextToHtml: function(a, b) {
                ...
                if (!e) { var m = /\n{2}/g; if (m.test(c)) var d = "\x3c" + g + "\x3e",
                        l = "\x3c/" + g + "\x3e",
                        c = d + c.replace(m, function() { return l + d }) + l }
                c = c.replace(/\n/g, "\x3cbr\x3e");
                e || (c =
                    c.replace(new RegExp("\x3cbr\x3e(?\x3d\x3c/" + g + "\x3e)"), function(a) { return CKEDITOR.tools.repeat(a, 2) }));
                c = c.replace(/^ | $/g, "\x26nbsp;");
                return c = c.replace(/(>|\s) /g, function(a, b) { return b + "\x26nbsp;" }).replace(/ (?=<)/g, "\x26nbsp;")
            },
            ...
            setTimeout: function(a, b, e, c, g) { g || (g = window);
                e || (e = g); return g.setTimeout(function() { c ? a.apply(e, [].concat(c)) : a.apply(e) }, b || 0) },
            throttle: function(a, b, e) { return new this.buffers.throttle(a, b, e) },
            ...
            indexOf: function(a, b) { if ("function" == typeof b)
                    for (var e = 0, c = a.length; e < c; e++) { if (b(a[e])) return e } else { if (a.indexOf) return a.indexOf(b);
                        e = 0; for (c = a.length; e < c; e++)
                            if (a[e] === b) return e }
                return -1 },
            search: function(a, b) { var e = CKEDITOR.tools.indexOf(a, b); return 0 <= e ? a[e] : null },
            bind: function(a, b) { var e = Array.prototype.slice.call(arguments, 2); return function() { return a.apply(b, e.concat(Array.prototype.slice.call(arguments))) } },
            createClass: function(a) {
                ...
                e && (b.prototype = this.prototypedCopy(e.prototype), b.prototype.constructor = b, b.base = e, b.baseProto = e.prototype, b.prototype.base = function y() { this.base = e.prototype.base;
            ...
            addFunction: function(a,
                e) { return b.push(function() { return a.apply(e || this, arguments) }) - 1 },
            ...
            cssLength: function() { var a = /^-?\d+\.?\d*px$/,
                    b; return function(e) { b = CKEDITOR.tools.trim(e + "") + "px"; return a.test(b) ? b : e || "" } }(),
            convertToPx: function() {
                ...
                return function(b) {
                    ...
                    if (!/%$/.test(b)) { var e = 0 > parseFloat(b);
                        e && (b = b.replace("-", ""));
                        a.setStyle("width", b);
                        b = a.$.clientWidth; return e ? -b : b }
                    return b
                }
            }(),
            repeat: function(a, b) { return Array(b + 1).join(a) },
            tryThese: function() { for (var a, b = 0, e = arguments.length; b < e; b++) { var c = arguments[b]; try { a = c(); break } catch (g) {} } return a },
            ...
            normalizeCssText: function(a, b) { var e = [],
                    c, g = CKEDITOR.tools.parseCssText(a, !0, b); for (c in g) e.push(c + ":" + g[c]);
                e.sort(); return e.length ? e.join(";") + ";" : "" },
            convertRgbToHex: function(a) { return a.replace(/(?:rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\))/gi, function(a, b, e, c) { a = [b, e, c]; for (b = 0; 3 > b; b++) a[b] = ("0" + parseInt(a[b], 10).toString(16)).slice(-2); return "#" + a.join("") }) },
            ...
            parseCssText: function(a, b, e) { var c = {};
                ...
                a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function(a, e, x) { b && (e = e.toLowerCase(), "font-family" == e && (x = x.replace(/\s*,\s*/g, ",")), x = CKEDITOR.tools.trim(x));
                    c[e] = x }); return c },
            writeCssText: function(a, b) { var e, c = []; for (e in a) c.push(e + ":" + a[e]);
                b && c.sort(); return c.join("; ") },
            objectCompare: function(a, b, e) { var c; if (!a && !b) return !0; if (!a || !b) return !1; for (c in a)
                    if (a[c] != b[c]) return !1;
                if (!e)
                    for (c in b)
                        if (a[c] != b[c]) return !1;
            ...
            convertArrayToObject: function(a, b) { var e = {};
                1 == arguments.length && (b = !0); for (var c = 0, g = a.length; c < g; ++c) e[a[c]] = b; return e },
            fixDomain: function() {
                for (var a;;) try {
                    a = window.parent.document.domain;
                    break
                } catch (b) { a = a ? a.replace(/.+?(?:\.|$)/, "") : document.domain; if (!a) break;
                    document.domain = a }
                return !!a
            },
            eventsBuffer: function(a, b, e) { return new this.buffers.event(a, b, e) },
            enableHtml5Elements: function(a, b) { for (var e = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "), c = e.length, g; c--;) g = a.createElement(e[c]), b && a.appendChild(g) },
            ...
            checkIfAnyObjectPropertyMatches: function(a, b) { for (var e in a)
                    if (e.match(b)) return !0;
                return !1 },
            keystrokeToString: function(a, b) { var e = this.keystrokeToArray(a, b);
            ...
            getMouseButton: function(a) { return (a = a && a.data ? a.data.$ : a) ? CKEDITOR.tools.normalizeMouseButton(a.button) : !1 },
            normalizeMouseButton: function(a, b) {
                ...
                for (var e = [
                    ...
                    ], c = 0; c < e.length; c++) { var g = e[c]; if (g[0] === a && b) return g[1]; if (!b && g[1] === a) return g[0] }
            },
            convertHexStringToBytes: function(a) { var b = [],
                    e = a.length / 2,
                    c; for (c = 0; c < e; c++) b.push(parseInt(a.substr(2 * c, 2), 16)); return b },
            ...
            style: {
                parse: {
                    ...
                    background: function(a) {
                        var b = {},
                            e = this._findColor(a);
                        e.length && (b.color = e[0], CKEDITOR.tools.array.forEach(e, function(b) { a = a.replace(b, "") }));
                    ...
                    sideShorthand: function(a, b) {
                        function e(a) { c.top = g[a[0]];
                            c.right = g[a[1]];
                            c.bottom = g[a[2]];
                            c.left = g[a[3]] } var c = {},
                            g = b ? b(a) : a.split(/\s+/); switch (g.length) {
                            case 1:
                                e([0, 0, 0, 0]); break;
                            case 2:
                                e([0, 1, 0, 1]); break;
                    ...
                    _findColor: function(a) { var b = [],
                            ...
                            b = b.concat(a.match(this._hslaRegExp) || []); return b = b.concat(e.filter(a.split(/\s+/), function(a) { return a.match(/^\#[a-f0-9]{3}(?:[a-f0-9]{3})?$/gi) ? !0 : a.toLowerCase() in CKEDITOR.tools.style.parse._colors })) }
                }
            },
            array: {
                filter: function(a, b, e) { var c = [];
                    this.forEach(a, function(g, m) { b.call(e, g, m, a) && c.push(g) }); return c },
                find: function(a, b, e) { for (var c = a.length, g = 0; g < c;) { if (b.call(e, a[g], g, a)) return a[g];
                        g++ } },
                forEach: function(a, b, e) { var c = a.length,
                        g; for (g = 0; g < c; g++) b.call(e, a[g], g, a) },
                map: function(a, b, e) { for (var c = [], g = 0; g < a.length; g++) c.push(b.call(e, a[g], g, a)); return c },
                reduce: function(a, b, e, c) { for (var g = 0; g < a.length; g++) e = b.call(c, e, a[g], g, a); return e },
                every: function(a, b, e) { if (!a.length) return !0;
                    b = this.filter(a, b, e); return a.length === b.length },
                some: function(a, b, e) { for (var c = 0; c < a.length; c++)
            ...
            object: {
                ...
                values: function(a) { return CKEDITOR.tools.array.map(CKEDITOR.tools.object.keys(a), function(b) { return a[b] }) },
                keys: function(a) {
                    var b = Object.prototype.hasOwnProperty,
                        e = [],
                        c = CKEDITOR.tools.object.DONT_ENUMS;
                    if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version && (!a || "object" !== typeof a)) { b = []; if ("string" === typeof a)
                            for (e = 0; e < a.length; e++) b.push(String(e)); return b }
                ...
                findKey: function(a, b) { if ("object" !== typeof a) return null; for (var e in a)
                        if (a[e] === b) return e;
                    return null },
                merge: function(a, b) { var e = CKEDITOR.tools,
                        c = e.clone(a),
                        g = e.clone(b);
                    e.array.forEach(e.object.keys(g), function(a) { c[a] = "object" === typeof g[a] && "object" === typeof c[a] ? e.object.merge(c[a], g[a]) : g[a] }); return c }
            },
        ...
        a.prototype = {
            reset: function() { this._lastOutput = 0;
                this._clearTimer() },
        ...
        d.prototype._call = function() { this._output.apply(this._context, this._args) };
        ...
        CKEDITOR.tools.style.border = CKEDITOR.tools.createClass({
            ...
            _: {
                ...
                normalize: function() { for (var a in this._.normalizeMap) { var b = this[a];
                        b && (this[a] = CKEDITOR.tools.array.reduce(this._.normalizeMap[a], function(a, b) { return a.replace(b[0], b[1]) }, b)) } }
            },
            proto: { toString: function() { return CKEDITOR.tools.array.filter([this.width, this.style, this.color], function(a) { return !!a }).join(" ") } },
            statics: {
                ...
                splitCssValues: function(a, b) {
                    b = b || {};
                    var e = CKEDITOR.tools.array.reduce(["width", "style", "color"], function(e, c) { var g = a["border-" + c] || b[c];
                        e[c] = g ? CKEDITOR.tools.style.parse.sideShorthand(g) : null; return e }, {});
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        ...
        getAddress: function(a) { for (var d = [], b = this.getDocument().$.documentElement, c = this; c && c != b;) { var f = c.getParent();
        ...
        getAscendant: function(a, d) { var b = this.$,
                c, f;
            d || (b = b.parentNode); "function" == typeof a ? (f = !0, c = a) : (f = !1, c = function(b) { b = "string" == typeof b.nodeName ? b.nodeName.toLowerCase() : ""; return "string" == typeof a ? b == a : b in a }); for (; b;) { if (c(f ? new CKEDITOR.dom.node(b) : b)) return new CKEDITOR.dom.node(b); try { b = b.parentNode } catch (h) { b = null } } return null },
    ...
    (function() {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            getName: function() { var a = this.$.nodeName.toLowerCase(); if (CKEDITOR.env.ie && 8 >= document.documentMode) { var b = this.$.scopeName; "HTML" != b && (a = b.toLowerCase() + ":" + a) }
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    k && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || h.scrollLeft, c = d.$.scrollTop || h.scrollTop) : (c = t ? d.$ : h, b = c.scrollLeft, c = c.scrollTop), b = f.left + b - m, c = f.top + c - r) } else
                    for (r = this, m = null; r && "body" != r.getName() &&
                        "html" != r.getName();) { b += r.$.offsetLeft - r.$.scrollLeft;
                        c += r.$.offsetTop - r.$.scrollTop;
                        r.equals(this) || (b += r.$.clientLeft || 0, c += r.$.clientTop || 0); for (; m && !m.equals(r);) b -= m.$.scrollLeft, c -= m.$.scrollTop, m = m.getParent();
                        m = r;
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                function r(a, b) { var c = { x: 0, y: 0 }; if (!a.is(k ? "body" : "html")) { var e = a.$.getBoundingClientRect();
                        c.x = e.left;
                        c.y = e.top }
                    e = a.getWindow();
                    e.equals(b) || (e = r(CKEDITOR.dom.element.get(e.$.frameElement), b), c.x += e.x, c.y += e.y); return c }
            ...
            isDetached: function() { var a = this.getDocument(),
                    b = a.getDocumentElement(); return b.equals(this) || b.contains(this) ? !CKEDITOR.env.ie || 8 < CKEDITOR.env.version && !CKEDITOR.env.quirks ? !a.$.defaultView : !1 : !0 }
        });
    ...
    (function() {
        function a(a, b) {
            ...
            h = g ? function(a, b) { return !1 === C(a, b) ? !1 : g(a, b) } : C;
        ...
        CKEDITOR.dom.element.prototype.getBogus = function() { var a = this;
            do a = a.getPreviousSourceNode(); while (l(a)); return a && (CKEDITOR.env.needsBrFiller ? a.is && a.is("br") : a.getText && f.test(a.getText())) ? a : !1 }
    })();
    ...
    (function() {
        ...
        function d(a, b, c, d, f) {
            function h(a, b, c, e) { var A = c ? a.getPrevious() : a.getNext(); if (e && k) return A;
                l || e ? b.append(a.clone(!0, f), c) : (a.remove(), u && b.append(a, c)); return A }

            function m() { var a, b, c, e = Math.min(S.length, n.length); for (a = 0; a < e; a++)
            ...
            if (l && D.type == CKEDITOR.NODE_TEXT && (p.equals(D) || p.type === CKEDITOR.NODE_ELEMENT && p.getFirst().equals(D))) c.append(a.document.createText(D.substring(G, B)));
                ...
                for (var S = p.getParents(), n = D.getParents(), O = m(),
                        H = S.length - 1, F = n.length - 1, K = c, A, ba, L, da = -1, T = O; T <= H; T++) { ba = S[T];
                    L = ba.getNext(); for (T != H || ba.equals(n[T]) && H < F ? b && (A = K.append(ba.clone(0, f))) : N ? h(ba, K, !1, C) : v && K.append(a.document.createText(ba.substring(G))); L;) { if (L.equals(n[T])) { da = T; break }
                        L = h(L, K) }
                    K = A }
                K = c;
                for (T = O; T <= F; T++)
                    if (c = n[T], L = c.getPrevious(), c.equals(S[T])) b && (K = K.getChild(0));
                    else { T != F || c.equals(S[T]) && F < H ? b && (A = K.append(c.clone(0, f))) : q ? h(c, K, !1, w) : Q && K.append(a.document.createText(c.substring(0, B))); if (T > da)
                            for (; L;) L = h(L, K, !0);
                        K = A }
                l ||
                    g()
        ...
        function f(a) { return function() { var b; return this[a ? "getPreviousNode" : "getNextNode"](function(a) {!b && u(a) && (b = a); return l(a) && !(k(a) && a.equals(b)) }) } }
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            moveToBookmark: function(a) {
                if (a.is2) { var b = this.document.getByAddress(a.start, a.normalized),
                    ...
                    a = a.endOffset;
                    this.setStart(b, c);
                    d ? this.setEnd(d, a) : this.collapse(!0) } else b = (c = a.serializable) ? this.document.getById(a.startNode) : a.startNode, a = c ? this.document.getById(a.endNode) :
            ...
            enlarge: function(a, b) {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        var h = function(a, b) {
                            ...
                            var c = new CKEDITOR.dom.walker(c),
                                e;
                            for (c.guard =
                                function(a) { return !(a.type == CKEDITOR.NODE_ELEMENT && a.isBlockBoundary()) }; e = c.next();) { if (e.type != CKEDITOR.NODE_TEXT) return !1;
                                N = e != a ? e.getText() : e.substring(b); if (d.test(N)) return !1 }
                            return !0
                        };
                        ...
                        for (l = c(l); l || p;) {
                            if (l && !p) {!D && l.equals(m) && (D = !0); if (f ? l.isBlockBoundary() : !g.contains(l)) break;
                                        ...
                                        if (G && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                            ...
                                            if (d.test(N)) p = null;
                                                ...
                                                for (var q = p.$.getElementsByTagName("*"), C = 0, w; w = q[C++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[w.nodeName.toLowerCase()]) { p = null; break }
                                            p && (B = !!N.length)
                                        } else p = null;
                                    B && (G ? D ? k = l : l && this.setStartBefore(l) : G = !0);
                                    if (p) { B = p.getPrevious(); if (!l && !B) { l = p;
                                            p = null; break }
                                        p = B } else l = null
                                }
                            l && (l = c(l.getParent()))
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var v, Q, S = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null),
                            n = null,
                            O = function(a) { if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable"))
                                    if (n) { if (n.equals(a)) { n = null; return } } else n = a;
                                else if (n) return; var b = S(a);
                                b || (v = a); return b },
                            f = function(a) { var b = O(a);!b && a.is && a.is("br") && (Q = a); return b };
                        l.guard = O;
                        l = l.lastBackward();
                        v = v || g;
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { l = this.clone();
                            l = new CKEDITOR.dom.walker(l); var H = CKEDITOR.dom.walker.whitespaces(),
                                F = CKEDITOR.dom.walker.bookmark();
                            l.evaluator = function(a) { return !H(a) && !F(a) }; if ((l = l.previous()) && l.type == CKEDITOR.NODE_ELEMENT && l.is("br")) break }
                        l = this.clone();
                        l.collapse();
            ...
            getClientRects: function() {
                function a(b, c) {
                    ...
                    if (e = CKEDITOR.tools.array.map(e, function(a) { var b = c.root.editor;
                        ...
                        function b(e) { CKEDITOR.tools.array.forEach(d, function(b, f) { var h = CKEDITOR.tools.objectCompare(a[e], b);
                                h || (h = CKEDITOR.tools.objectCompare(a.widgetRect, b));
                                h && (Array.prototype.splice.call(d, f, a.length - e, a.widgetRect), c = !0) });
                            c || (e < d.length - 1 ? b(e + 1) : d.push(a.widgetRect)) } var c;
                        b(0) }), d
                }
            ...
            getNextParagraph: function(a) {
                ...
                for (this._.nextNode = null; m;) {
                    ...
                    if (J) m.type == CKEDITOR.NODE_TEXT && f.test(m.getText()) && (J = 0);
                        ...
                        var p = m.getName();
                        if (CKEDITOR.dtd.$block[p] && "false" == m.getAttribute("contenteditable")) { d = m;
                            b(this, a, d); break } else if (m.isBlockBoundary(this.forceBrBreak && !y && { br: 1 })) { if ("br" == p) J = 1;
                            else if (!k && !m.getChildCount() && "hr" != p) { d = m;
                                t = m.equals(r); break }
                            k && (k.setEndAt(m, CKEDITOR.POSITION_BEFORE_START), "br" != p && (this._.nextNode = m));
                            M = 1 } else { if (m.getFirst()) { k || (k = this.range.clone(), k.setStartAt(m, CKEDITOR.POSITION_BEFORE_START));
                    ...
                    t = (!M || J) && m.equals(r);
                    if (k && !M)
                        for (; !m.getNext(g) && !t;) { p = m.getParent(); if (p.isBlockBoundary(this.forceBrBreak && !y && { br: 1 })) { M = 1;
                                J = 0;
                                t || p.equals(r);
                                k.setEndAt(p, CKEDITOR.POSITION_BEFORE_END); break }
                            m = p;
                            J = 1;
                            t = m.equals(r);
                            E = 1 }
    ...
    (function() {
        function a(a, b, c, d, e) {
            ...
            for (d = a.length; c < d; ++c) {
                ...
                for (q in S) { w = S[q];
                    m = n[w];
                    g = [];
                    H = void 0; for (H in m) - 1 < H.indexOf("*") ? g.push(new RegExp("^" + H.replace(/\*/g, ".*") + "$")) : g.push(H);
                    m = g;
                    m.length && (n[w] = m, h = !1) }
                n.nothingRequired = h;
        ...
        function c(a, b, c) { if (!a.match || a.match(b)) { if (a.noProperties) return !1;
                ...
                a = a.classes;
                b = b.classes; if (a) { for (var d = !1, e = !0 === a, p = b.length; p--;)
        ...
        function l(a, b) { if (!b) return !0; for (var c = 0, d; c < b.length; ++c)
        ...
        function e(a) { var b, c, d, e, f = {},
                p = 1; for (a = w(a); b = a.match(n);)(c = b[2]) ? (d = x(c, "styles"), e = x(c, "attrs"), c = x(c, "classes")) : d = e = c = null, f["$" + p++] = { elements: b[1], classes: c, styles: d, attributes: e }, a = a.slice(b[0].length); return f }

        function x(a, b) { var c = a.match(O[b]); return c ? w(c[1]) : null }
        ...
        function z(a, b, e, f) {
            ...
            if (f.doCallbacks && a.elementCallbacks) { a: { w = a.elementCallbacks; for (var q = 0, h = w.length, g; q < h; ++q)
                        if (g = w[q](b)) { w = g; break a }
                    w = void 0 } if (w) return w }
            if (f.doTransform && (w = a._.transformations[b.name])) { t(b); for (q = 0; q < w.length; ++q) p(a, b, w[q]);
                r(b) }
            if (f.doFilter) {
                a: {
                    ...
                    if (a || w) { t(b); if (q)
                            for (v = 0, C = q.length; v < C; ++v)
                                if (!1 === c(q[v], b, k)) { a = null; break a }
                        if (h)
                            for (v = 0, C = h.length; v < C; ++v) c(h[v], b, k); if (a)
                            for (v = 0, C = a.length; v < C; ++v) d(a[v], b, k, g); if (w)
                ...
                if (!a.allStyles || a.hadInvalidStyle) { for (G in D) a.allStyles || O[G] ? K.push(G + ":" + D[G]) : v = !0;
                    K.length && (q.style = K.sort().join("; ")) } else B && (q.style = B);
                if (!a.allClasses ||
                    a.hadInvalidClass) { for (G = 0; G < h.length; ++G)(a.allClasses || w[h[G]]) && k.push(h[G]);
                    k.length && (q["class"] = k.sort().join(" "));
                    g && k.length < g.split(/\s+/).length && (v = !0) } else g && (q["class"] = g);v && (n = 1);
        ...
        function M(a) { if (!a) return !1; if (!0 === a) return !0; var b = I(a); return function(c) { return c in a || b && c.match(b) } }
        ...
        function E(a, b, c) {
            ...
            if (q.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(y()) : (a.parent && c.push({ check: "it", el: a.parent }), a.remove());
                ...
                if ("br" == b) a.previous && !J(a.previous) && (b = y(), b.insertBefore(a)), a.next && !J(a.next) && (b = y(), b.insertAfter(a)), a.replaceWithChildren();
                    ...
                    var d = a.children,
                        e;
                    b: { e = q[b]; for (var f = 0, p = d.length, n; f < p; ++f)
                            if (n = d[f], n.type == CKEDITOR.NODE_ELEMENT && !e[n.name]) { e = !1; break b }
                        e = !0 }
                    if (e) a.name = b, a.attributes = {}, c.push({ check: "parent-down", el: a });
                    else { e = a.parent; for (var f = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == e.name, w, h, p = d.length; 0 < p;) n = d[--p], f && (n.type == CKEDITOR.NODE_TEXT || n.type == CKEDITOR.NODE_ELEMENT && q.$inline[n.name]) ? (w || (w = new CKEDITOR.htmlParser.element(b), w.insertAfter(a), c.push({ check: "parent-down", el: w })), w.add(n, 0)) : (w = null, h = q[e.name] || q.span, n.insertAfter(a), e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || n.type != CKEDITOR.NODE_ELEMENT || h[n.name] || c.push({ check: "el-up", el: n }));
                        a.remove() }
                }
            else d in { style: 1, script: 1 } ? a.remove() : (a.parent && c.push({ check: "it", el: a.parent }), a.replaceWithChildren())
        }

        function p(a, b, c) { var d, e; for (d = 0; d < c.length; ++d)
                if (e = c[d], !(e.check && !a.check(e.check, !1) || e.left && !e.left(b))) { e.right(b, K); break } }
        ...
        function D(a, b) {
            ...
            for (f in d)
                if ("class" == f)
                    for (c = d[f].split(/\s+/), n = a.classes.join("|"); w = c.pop();) { if (-1 == n.indexOf(w)) return !1 } else if (a.attributes[f] != d[f]) return !1;
            for (p in e)
                if (a.styles[p] !=
                    e[p]) return !1;
            return !0
        ...
        function G(a, b) { var c, d; "string" == typeof a ? c = a : a instanceof CKEDITOR.style ? d = a : (c = a[0], d = a[1]); return [{ element: c, left: d, right: function(a, c) { c.transform(a, b) } }] }

        function B(a) { return function(b) { return D(b, a) } }
        ...
        CKEDITOR.filter.prototype = {
            allow: function(b, c, d) {
                ...
                } else if (CKEDITOR.tools.isArray(b)) { for (f = 0; f < b.length; ++f) p = this.allow(b[f], c, d); return p }
            ...
            applyTo: function(a, b, c, d) {
                ...
                a.forEach(function(a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) { if ("off" == a.attributes["data-cke-filter"]) return !1; if (!b || "span" != a.name || !~CKEDITOR.tools.object.keys(a.attributes).join("|").indexOf("data-cke-"))
            ...
            addContentForms: function(a) { if (!this.disabled && a) { var b, c, d = [],
                        e; for (b = 0; b < a.length && !e; ++b) c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (e = c); if (e) { for (b = 0; b < a.length; ++b) d.push(G(a[b], e));
                ...
                if (!this.disabled && a) {
                    ...
                    for (e = 0; e < a.length; ++e) {
                        ...
                        for (p = 0; p < b.length; ++p) n = b[p], "string" == typeof n ? (n = n.split(/\s*:\s*/), w = n[0], q = null, h = n[1]) : (w = n.check, q = n.left, h = n.right), f || (f = n, f = f.element ? f.element : w ? w.match(/^([a-z0-9]+)/i)[0] :
                            f.left.getDefinition().element), q instanceof CKEDITOR.style && (q = B(q)), c.push({ check: w == f ? null : w, left: q, right: "string" == typeof h ? N(h) : h });
                        b = f;
                        d[b] || (d[b] = []);
                        d[b].push(c)
                    }
            ...
            check: function(a, b, c) {
                ...
                } else f = a.getDefinition(), w = f.styles, d = f.attributes || {}, w && !CKEDITOR.tools.isEmpty(w) ? (w = C(w), d.style = CKEDITOR.tools.writeCssText(w, !0)) : w = {}, f = { name: f.element, attributes: d, classes: d["class"] ? d["class"].split(/\s+/) : [], styles: w, children: [] };
                ...
                z(this, w, q, { doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c });
            ...
            getAllowedEnterMode: function() {
                ...
                return function(c, d) { var f = a.slice(),
                        e; if (this.check(v[c])) return c; for (d || (f = f.reverse()); e = f.pop();)
        ...
        return {
            load: function(b, c, f, h) {
                ...
                var g = b.length,
                    l = [],
                    u = [],
                    e = function(a) { c && (k ? c.call(f, a) : c.call(f, l, u)) };
                if (0 === g) e(!0);
                else {
                    var x = function(a, b) {
                            (b ? l : u).push(a);
                            0 >= --g && (h && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), e(b)) },
                        t = function(b, c) { a[b] = 1; var f = d[b];
                        ...
                        z = function(b) {
                            if (a[b]) x(b, !0);
                                ...
                                if (!(1 < f.length)) {
                                    ...
                                    c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? e.$.onreadystatechange = function() { if ("loaded" == e.$.readyState || "complete" == e.$.readyState) e.$.onreadystatechange = null, t(b, !0) } : (e.$.onload = function() { setTimeout(function() { e.$.onload = null;
                                            e.$.onerror = null;
                                            t(b, !0) }, 0) }, e.$.onerror = function() { e.$.onload = null;
                                        e.$.onerror = null;
                                        t(b, !1) }));
    ...
    CKEDITOR.resourceManager.prototype = {
        ...
        addExternal: function(a, d, b) { b || (d = d.replace(/[^\/]+$/, function(a) { b = a; return "" }));
            b = b || this.fileName + ".js";
            a = a.split(","); for (var c = 0; c < a.length; c++) this.externals[a[c]] = { dir: d, file: b } },
        load: function(a, d, b) {
            CKEDITOR.tools.isArray(a) || (a = a ? [a] : []);
            for (var c = this.loaded, f = this.registered, h = [], k = {}, g = {}, l = 0; l < a.length; l++) { var u = a[l]; if (u)
                    if (c[u] || f[u]) g[u] = this.get(u);
                    else { var e = this.getFilePath(u);
                        h.push(e);
                        e in k || (k[e] = []);
                        k[e].push(u) } }
            CKEDITOR.scriptLoader.load(h,
                function(a, e) { if (e.length) throw Error('[CKEDITOR.resourceManager.load] Resource name "' + k[e[0]].join(",") + '" was not found at "' + e[0] + '".'); for (var f = 0; f < a.length; f++)
                        for (var h = k[a[f]], l = 0; l < h.length; l++) { var m = h[l];
                            g[m] = this.get(m);
                            c[m] = 1 }
                    d.call(b, g) }, this)
        }
    ...
    (function() {
        ...
        function d() { do var a = "editor" + ++I; while (CKEDITOR.instances[a]); return a }
        ...
        function h(a, b, c) { if (b) { var d, e, f = a.commands; for (e in f) d = f[e], (c || d.contextSensitive) && d.refresh(a, b) } }
        ...
        function l(a) { CKEDITOR.skin.loadPart("editor", function() { u(a) }) }
        ...
        function x(a) {
            ...
            CKEDITOR.plugins.load(d.split(","), function(b) {
                ...
                for (var p in b) {
                    ...
                    if (n && (O = n.match(g)))
                        for (; n = O.pop();) CKEDITOR.error("editor-plugin-required", { plugin: n.replace(",", ""), requiredBy: p });
                ...
                CKEDITOR.scriptLoader.load(f, function() {
                    if (!a.isDestroyed() && !a.isDetached()) {
                        for (var b = ["beforeInit", "init", "afterInit"], f = 0; f < b.length; f++)
                            for (var p = 0; p < d.length; p++) { var n = d[p];
                                0 === f && e[p] && n.lang && n.langEntries && (a.lang[n.name] = n.langEntries[e[p]]); if (n[b[f]]) n[b[f]](a) }
        ...
        function t() { var a = this.element; if (a && this.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO) { var b = this.getData();
        ...
        function z(a, b) {
            ...
            for (var e = new CKEDITOR.dom.documentFragment, f, h, g, k = 0; k < a.length; k++) {
                ...
                c(l) ? (f || (f = q.getAscendant("table").clone(), f.append(q.getAscendant({ thead: 1, tbody: 1, tfoot: 1 }).clone()), e.append(f), f = f.findOne("thead, tbody, tfoot")), h && h.equals(q) || (h =
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            _attachToForm: function() {
                ...
                d.is("textarea") && e && (e.on("submit", a), b(e.$.submit) && (e.$.submit = CKEDITOR.tools.override(e.$.submit, function(b) { return function() { a();
                        b.apply ? b.apply(this) : b() } })), c.on("destroy", function() {
                    e.removeListener("submit",
                        a)
                }))
            },
            destroy: function(a) { var b = CKEDITOR.filter.instances,
                    c = this;
                this.fire("beforeDestroy");!a && t.call(this);
                this.editable(null);
                this.filter && delete this.filter;
                CKEDITOR.tools.array.forEach(CKEDITOR.tools.object.keys(b), function(a) { a = b[a];
            ...
            setData: function(a,
                b, c) { var d = !0,
                    e = b;
                b && "object" == typeof b && (c = b.internal, e = b.callback, d = !b.noSnapshot);!c && d && this.fire("saveSnapshot"); if (e || !c) this.once("dataReady", function(a) {!c && d && this.fire("saveSnapshot");
                    e && e.call(a.editor) });
            ...
            insertHtml: function(a,
                b, c) { this.fire("insertHtml", { dataValue: a, mode: b, range: c }) },
            ...
            getCommandKeystroke: function(a, b) { var c = "string" === typeof a ? this.getCommand(a) : a,
                    d = []; if (c) { var e = CKEDITOR.tools.object.findKey(this.commands, c),
                        f = this.keystrokeHandler.keystrokes; if (c.fakeKeystroke) d.push(c.fakeKeystroke);
                    else
                        for (var h in f) f[h] === e && d.push(h) } return b ? d : d[0] || null },
            ...
            parse: function(b) {
                for (var c, f, h = 0, k; c = this._.htmlPartsRegex.exec(b);) {
                    ...
                    if (k) k.push(c[0]);
                                ...
                                l, u = c[4];
                            c = !!c[5]; if (u)
                                for (; l = a.exec(u);) { var e = l[1].toLowerCase();
                                    l = l[2] || l[3] || l[4] || "";
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(h, k, g) {
                function l(a) { var b; if (0 < m.length)
                ...
                function u() { for (; M.length;) x(M.shift(), y) }
                ...
                function x(b, c, d) { c = c || y || r; var f = y;
                ...
                I.onTagOpen = function(e, f, h, g) {
                    ...
                    if (a(f)) m.push(f);
                        ...
                        if ("pre" == e) E = !0;
                        else { if ("br" == e && E) { y.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == e && (J = !0) }
                        if ("br" == e) M.push(f);
                        else {
                ...
                I.onText = function(a) { if (!(y._.hasInlineStarted && !M.length || E || J) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return; var b = y.name,
                        e = b ? CKEDITOR.dtd[b] || (y._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c; if (!J && !e["#"] && b in d) I.onTagOpen(f[b] || ""), I.onText(a);
                    else { u();
                        l();
                        E || J || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
                        a = new CKEDITOR.htmlParser.text(a); if (t(y, a)) this.onTagOpen(g, {}, 0, 1);
                        y.add(a) } };
                I.onCDATA =
                    function(a) { y.add(new CKEDITOR.htmlParser.cdata(a)) };
                I.onComment = function(a) { u();
                    l();
            ...
            exec: function(a, c) {
                ...
                for (x = 0; x < g; x++)
                    if (d && (l = c.type, u = c.name), e = k[x], !(a.nonEditable && !e.options.applyToAll ||
                            a.nestedEditable && e.options.excludeNestedEditable)) { e = e.value.apply(null, h); if (!1 === e || d && e && (e.name != u || e.type != l)) return e;
                        null != e && (h[0] = c = e) }
                return c
            },
    ...
    (function() {
        ...
        function l(a) { a = a.attributes; switch (a["data-cke-editable"]) {
                case "true":
        ...
        function e(a, b) { return a.replace(b, function(a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + r(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e"); return "\x3ccke:encoded\x3e" + encodeURIComponent(a) + "\x3c/cke:encoded\x3e" }) }

        function x(a) { return a.replace(n, function(a, b) { return decodeURIComponent(b) }) }
        ...
        function z(a) { return CKEDITOR.tools.array.reduce(a.split(""), function(a, b) { var c = b.toLowerCase(),
                    d = b.toUpperCase(),
                    e = I(c);
                c !== d && (e += "|" + I(d)); return a + ("(" + e + ")") }, "") }

        function I(a) { var b;
            b = a.charCodeAt(0); var c = b.toString(16);
            b = { htmlCode: "\x26#" + b + ";?", hex: "\x26#x0*" + c + ";?", entity: { "\x3c": "\x26lt;", "\x3e": "\x26gt;", ":": "\x26colon;" }[a] }; for (var d in b) b[d] && (a += "|" + b[d]); return a }
        ...
        function m(a, b) { var c = b._.dataStore; return a.replace(/\x3c!--\{cke_protected\}([\s\S]+?)--\x3e/g, function(a, b) { return decodeURIComponent(b) }).replace(/\{cke_protected_(\d+)\}/g, function(a, b) { return c && c[b] || "" }) }
        ...
        function M(a, b) {
            ...
            a = a.replace(/\x3c!--[\s\S]*?--\x3e/g,
                function(a) { return "\x3c!--{cke_tempcomment}" + (c.push(a) - 1) + "--\x3e" });
            for (var n = 0; n < d.length; n++) a = a.replace(d[n], function(a) { a = a.replace(f, function(a, b, d) { return c[d] }); return /cke_temp(comment)?/.test(a) ? a : "\x3c!--{cke_temp}" + (c.push(a) - 1) + "--\x3e" });
            a = a.replace(f, function(a, b, d) { return "\x3c!--" + J + (b ? "{C}" : "") + encodeURIComponent(c[d]).replace(/--/g, "%2D%2D") + "--\x3e" });
        ...
        CKEDITOR.htmlDataProcessor = function(b) {
            ...
            b.on("toHtml", function(a) { a.data.dataValue.filterChildren(n.dataFilter, !0) }, null, null, 10);
            ...
            b.on("toDataFormat", function(a) { a.data.dataValue.filterChildren(n.htmlFilter, !0) }, null, null, 10);
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function(a, b, c, d) { var e = this.editor,
                    f, n, q, w;
                b && "object" == typeof b ? (f = b.context, c = b.fixForBody, d = b.dontFilter, n = b.filter, q = b.enterMode, w = b.protectedWhitespaces) : f = b;
                f || null === f || (f = e.editable().getName()); return e.fire("toHtml", { dataValue: a, context: f, fixForBody: c, dontFilter: d, filter: n || e.filter, enterMode: q || e.enterMode, protectedWhitespaces: w }).dataValue },
        ...
        var y = /(?:&nbsp;|\xa0)$/,
            ...
            N = { elements: { embed: function(a) { var b = a.parent; if (b && "object" == b.name) { var c = b.attributes.width,
        ...
        CKEDITOR.env.ie && (q.attributes.style = function(a) { return a.replace(/(^|;)([^\:]+)/g, function(a) { return a.toLowerCase() }) });
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            writeHtml: function(a, b) { b && this.filter(b); var h = this.name,
                    ...
                    g = this.attributes,
                    l, u;
                a.openTag(h, g); for (l in g) k.push([l, g[l]]);
                a.sortAttributes && k.sort(d);
                l = 0; for (u = k.length; l < u; l++) g = k[l], a.attribute(g[0], g[1]);
            ...
            findOne: function(a, b) { var d = null,
                    k = CKEDITOR.tools.array.find(this.children, function(g) { var k = "function" === typeof a ? a(g) : g.name === a; if (k || !b) return k;
                        g.children && g.findOne && (d = g.findOne(a, !0)); return !!d }); return d || k || null },
    ...
    (function() {
        CKEDITOR.inline = function(a, d) {
            ...
            b.on("destroy", function() { var a = b.container;
        ...
        CKEDITOR.editor.prototype.setMode = function(a, b) {
            ...
            if (a != d.mode && k && k[a]) {
                ...
                if (d.mode) { var g = d.checkDirty(),
                    ...
                    d._.previousModeData = l = d.getData(1); "source" == d.mode && k == l && (d.fire("lockSnapshot", { forceUpdate: !0 }), u = 1);
    ...
    (function() {
        ...
        function h(a) {
            ...
            if (e.startPath().contains(f)) { var q = e.clone();
                ...
                a.guard = b();
                a.checkBackward(); if (d) return q = e.clone(), q.collapse(), q.setEndAt(d, CKEDITOR.POSITION_AFTER_END), a = new CKEDITOR.dom.walker(q), a.guard = b(!0), d = !1, a.checkForward(), d }
            return null
        }
        ...
        function u(a) { var b = a.editor;
            b.getSelection().scrollIntoView();
            setTimeout(function() { b.fire("saveSnapshot") }, 0) }

        function e(a, b, c) { var d = a.getCommonAncestor(b); for (b = a = c ? b : a;
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                focus: function() {
                    ...
                    try { if (!CKEDITOR.env.ie || CKEDITOR.env.edge && 14 < CKEDITOR.env.version || !this.getDocument().equals(CKEDITOR.document))
                            if (CKEDITOR.env.chrome) { var b = this.$.scrollTop;
                                this.$.focus();
                                this.$.scrollTop = b } else this.$.focus();
                        else this.$.setActive() } catch (c) { if (!CKEDITOR.env.ie) throw c; }
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    if (f)
                        for (;
                            ...
                            if (g.getName() in
                                CKEDITOR.dtd.span) { var f = b.splitElement(g),
                                    h = b.createBookmark();
                                l(g);
                                l(f);
                                b.moveToBookmark(h) } else b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(g), b.collapse(!0), g.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                    b.insertNode(a);
                    return !0
                },
                ...
                detach: function() { this.status = "detached";
                    this.editor.setData(this.editor.getData(), { internal: !0 });
                    this.clearListeners(); try { this._.cleanCustomData() } catch (a) { if (!CKEDITOR.env.ie || -2146828218 !== a.number) throw a; }
                ...
                extractHtmlFromRange: function(a, b) {
                    ...
                    if (b) { c = a.startPath(); if (d = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) { a: { var d = c.block.getElementsByTag("span"),
                                ...
                                d = !1 }
                            d = !d }
                        d && (a.moveToPosition(c.block, CKEDITOR.POSITION_BEFORE_START), c.block.remove()) } else c.autoParagraph(this.editor, a), z(a.startContainer) && a.startContainer.appendBogus();
                ...
                setup: function() {
                    ...
                    this.attachListener(a, "beforeGetData", function() {
                        var b =
                            this.getData();
                        this.is("textarea") || !1 !== a.config.ignoreEmptyParagraph && (b = b.replace(r, function(a, b) { return b }));
                        a.setData(b, null, 1)
                    }, this);
                    ...
                    if (!this.is("textarea")) {
                        ...
                        a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller &&
                            this.attachListener(this, "keyup", function(b) { b.data.getKeystroke() in C && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this, CKEDITOR.POSITION_AFTER_START), b.select()) });
                            ...
                            if (c in C && (b = a.getSelection(), 0 !== b.getRanges().length)) {
                                ...
                                if (d.collapsed) a: {
                                    ...
                                    if (f && d[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && d.moveToClosestEditablePosition(f, !c) && d.collapsed) {
                                        if (d.startContainer.type == CKEDITOR.NODE_ELEMENT) { var n = d.startContainer.getChild(d.startOffset - (c ? 1 : 0)); if (n && n.type == CKEDITOR.NODE_ELEMENT && n.is("hr")) { a.fire("saveSnapshot");
                                                n.remove();
                                                b = !0; break a } }
                                        d = d.startPath().block;
        ...
        CKEDITOR.editor.prototype.editable = function(a) { var b = this._.editable; if (b && a) return 0; if (!arguments.length) return b;
            a ? b = a instanceof CKEDITOR.editable ? a : new CKEDITOR.editable(this, a) : (b && b.detach(), b = null); return this._.editable = b };
        ...
        m = function() {
            ...
            function f(b) { return b && a(b) && (b.is(w.$removeEmpty) || b.is("a") && !b.isBlockBoundary()) }
            ...
            return function(n, v, H, F) {
                ...
                if (!F.checkReadOnly()) {
                    ...
                    v = { type: v, dontFilter: A, editable: n, editor: K, range: F, blockLimit: t, mergeCandidates: [], zombies: [] };
                    var A = v.range,
                        t = v.mergeCandidates,
                        L = "html" === v.type,
                        r, x, z, y, I, U;
                    ...
                    if (!A.collapsed) { r = y.block || y.blockLimit; var aa = A.getCommonAncestor();
                    ...
                    if (n = H) {
                        n = v.range;
                        if ("text" == v.type && v.inlineStylesRoot) { F = v.inlineStylesPeak;
                            K = F.getDocument().createText("{cke-peak}"); for (U = v.inlineStylesRoot.getParent(); !F.equals(U);) K = K.appendTo(F.clone()), F = F.getParent();
                            H = K.getOuterHtml().split("{cke-peak}").join(H) }
                        F = v.blockLimit.getName();
                        if (/^\s+|\s+$/.test(H) && "span" in CKEDITOR.dtd[F]) { var J = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e';
                            H = J + H + J }
                        H = v.editor.dataProcessor.toHtml(H, { context: null, fixForBody: !1, protectedWhitespaces: !!J, dontFilter: v.dontFilter, filter: v.editor.activeFilter, enterMode: v.editor.activeEnterMode });
                    ...
                    if (n) {
                        ...
                        for (h(K, P); U < K.length; U++) {
                            A = K[U];
                            if (L = A.isLineBreak) L = P, r = F, y = z = void 0, A.hasBlockSibling ? L = 1 : (z = L.startContainer.getAscendant(w.$block, 1)) && z.is({ div: 1, p: 1 }) ? (y = z.getPosition(r), y ==
                            ...
                            if (L) H = 0 < U;
                                ...
                                if ((L = P.startPath().block) && !L.equals(E)) { if (R = L.getBogus()) R.remove(), J.push(L);
                                    E = L }
                                A.firstNotAllowed &&
                                    (x = 1);
                                if (x && A.isElement) { L = P.startContainer; for (r = null; L && !w[L.getName()][A.name];) { if (L.equals(F)) { L = null; break }
                                        r = L;
                                        L = L.getParent() } if (L) r && (Y = P.splitElement(r), v.zombies.push(Y), v.zombies.push(r));
                                    else { r = F.getName();
                                        Z = !U;
                                        L = U == K.length - 1;
                                        r = d(A.node, r);
                                        z = [];
                                        y = r.length; for (var aa = 0, ca = void 0, W = 0, V = -1; aa < y; aa++) ca = r[aa], " " == ca ? (W || Z && !aa || (z.push(new CKEDITOR.dom.text(" ")), V = z.length), W = 1) : (z.push(ca), W = 0);
                                        L && V == z.length && z.pop();
                                        Z = z } }
                                if (Z) { for (; L = Z.pop();) P.insertNode(L);
                                    Z = 0 } else P.insertNode(A.node);
                    ...
                    R.moveToBookmark(Z);
                    if (!v.dontMoveCaret) { for (E = e(R); E && a(E) && !E.is(w.$empty);) { if (E.isBlockBoundary()) R.moveToPosition(E, CKEDITOR.POSITION_BEFORE_END);
                            else { if (f(E) && E.getHtml().match(/(\s|&nbsp;)$/g)) { X = null; break }
                                X = R.clone();
        ...
        J = {
            ...
            bogus: { exclude: function(a) { var b = a.range.getBoundaryNodes(),
                        c = b.startNode,
                        b = b.endNode;!b || !I(b) || c && c.equals(b) || a.range.setEndBefore(b) } },
            tree: {
                rebuild: function(a, b) {
                    ...
                    if (e.blockLimit.is({ tr: 1, table: 1 })) { var h = e.contains("table").getParent();
                        g = function(a) { return !a.equals(h) } } else if (e.block && e.block.is(CKEDITOR.dtd.$listItem) && (f = f.contains(CKEDITOR.dtd.$list), c = c.contains(CKEDITOR.dtd.$list), !f.equals(c))) {
                ...
                table: function() {
                    function a(c) {
                        ...
                        g.guard = function(a, g) {
                            ...
                            else { if (l = !g) l = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!h || b(a, h)) && (!n || b(a, n)); if (!l && (l = g))
    ...
    (function() {
        ...
        function l(a) { return G(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? !0 : !1 }
        ...
        function e(a) { x(a, !1); var b = a.getDocument().createText(y);
        ...
        function t(a, b) { return b ? a.replace(J, function(a, b) { return b ? " " : "" }) : a.replace(y, "") }
        ...
        function I(a) { var b = { 37: 1, 39: 1, 8: 1, 46: 1 }; return function(c) { var d = c.data.getKeystroke(); if (b[d]) { var e = a.getSelection().getRanges(),
                        f = e[0];
            ...
            for (var b = 0; b < a.length; b++) {
                ...
                if (!c.collapsed) {
                    ...
                    d.evaluator = function(d) { if (d.type == CKEDITOR.NODE_ELEMENT && d.isReadOnly()) { var e = c.clone();
                            ...
                            d.getPosition(h.endContainer) & CKEDITOR.POSITION_CONTAINS || (e.setStartAfter(d), e.collapsed || a.splice(b + 1, 0, e)); return !0 } return !1 };
                    d.next()
                }
            }
            return a
        ...
        CKEDITOR.on("instanceCreated", function(a) {
            ...
            c.on("contentDom", function() {
                function a() { p = new CKEDITOR.dom.selection(c.getSelection());
                    p.lock() }

                function b() { f.removeListener("mouseup", b);
                    l.removeListener("mouseup", b); var a = CKEDITOR.document.$.selection,
                        c = a.createRange(); "None" != a.type && c.parentElement() && c.parentElement().ownerDocument == e.$ && c.select() }

                function d(a) {
                    a =
                        a.getRanges()[0];
                    return a ? (a = a.startContainer.getAscendant(function(a) { return a.type == CKEDITOR.NODE_ELEMENT && a.hasAttribute("contenteditable") }, !0)) && "false" === a.getAttribute("contenteditable") ? a : null : null
                }
                var e = c.document,
                    f = CKEDITOR.document,
                    g = c.editable(),
                ...
                g.attachListener(g, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusin" : "focus", function() { if (C && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) { C = c._.previousActive && c._.previousActive.equals(e.getActive()); var a = null != c._.previousScrollTop && c._.previousScrollTop != g.$.scrollTop;
                        CKEDITOR.env.webkit && C && a && (g.$.scrollTop = c._.previousScrollTop) }
                    c.unlockSelection(C);
                    C = 0 }, null, null, -1);
                g.attachListener(g, "mousedown", function() { C = 0 });
                if (CKEDITOR.env.ie || CKEDITOR.env.gecko || A) m ? g.attachListener(g,
                    "beforedeactivate", a, null, null, -1) : g.attachListener(c, "selectionCheck", a, null, null, -1), g.attachListener(g, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusout" : "blur", function() { var a = p && (p.isFake || 2 > p.getRanges().length);
                    CKEDITOR.env.gecko && !A && a || (c.lockSelection(p), C = 1) }, null, null, -1), g.attachListener(g, "mousedown", function() { C = 0 });
                if (CKEDITOR.env.ie && !A) {
                    var u;
                    g.attachListener(g, "mousedown", function(a) { 2 == a.data.$.button && ((a = c.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (u = c.window.getScrollPosition())) });
                    g.attachListener(g, "mouseup", function(a) { 2 == a.data.$.button && u && (c.document.$.documentElement.scrollLeft = u.x, c.document.$.documentElement.scrollTop = u.y);
                        u = null });
                    if ("BackCompat" != e.$.compatMode) {
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
                            var r, t;
                            l.on("mousedown", function(a) {
                                function b(a) { a = a.data.$; if (r) { var c = q.$.createTextRange(); try { c.moveToPoint(a.clientX, a.clientY) } catch (d) {}
                                ...
                                a = a.data;
                                if (a.getTarget().is("html") && a.$.y < l.$.clientHeight && a.$.x < l.$.clientWidth) { r = q.$.createTextRange(); try { r.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) {}
                                    t = r.duplicate();
                                    l.on("mousemove", b);
                                    f.on("mouseup", c);
                                    l.on("mouseup", c) }
                ...
                CKEDITOR.env.ie && g.attachListener(g, "keydown", function(a) { var b = this.getSelection(1),
                        c = d(b);
                    c && !c.equals(g) && (b.selectElement(c), a.data.preventDefault()) }, c);
                ...
                if (A && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
                    ...
                    g.attachListener(e.getDocumentElement(), "mouseup", function() { z && k.call(c);
                        z = 0 })
                } else g.attachListener(CKEDITOR.env.ie ? g : e.getDocumentElement(), "mouseup", k, c);
                CKEDITOR.env.webkit && g.attachListener(e, "keydown", function(a) { switch (a.data.getKey()) {
                        case 13:
                        case 33:
                        case 34:
                        case 35:
            ...
            c.on("loadSnapshot", function() { var a = CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_ELEMENT),
                    ...
                    b && b.hasAttribute("data-cke-hidden-sel") && (b.remove(), CKEDITOR.env.gecko && (a = c.editable().getFirst(a)) && a.is("br") && a.getAttribute("_moz_editor_bogus_node") && a.remove()) }, null, null,
                100);
        ...
        if (CKEDITOR.env.webkit) CKEDITOR.on("instanceReady", function(a) {
            ...
            b.on("selectionChange", function() { var a = b.editable(),
                ...
                c && (c.getCustomData("ready") ? (x(a), a.editor.fire("selectionCheck")) : c.setCustomData("ready", 1)) }, null, null, -1);
            b.on("beforeSetMode", function() { x(b.editable()) },
                null, null, -1);
            b.on("getSnapshot", function(a) { a.data && (a.data = t(a.data)) }, b, null, 20);
            b.on("toDataFormat", function(a) { a.data.dataValue = t(a.data.dataValue) }, null, null, 0)
        });
        ...
        CKEDITOR.editor.prototype.lockSelection =
            function(a) { a = a || this.getSelection(1); return a.getType() != CKEDITOR.SELECTION_NONE ? (!a.isLocked && a.lock(), this._.savedSelection = a, !0) : !1 };
        ...
        CKEDITOR.dom.range.prototype.select =
            function() { var a = this.root instanceof CKEDITOR.editable ? this.root.editor.getSelection() : new CKEDITOR.dom.selection(this.root);
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.selection, { _removeFillingCharSequenceString: t, _createFillingCharSequenceNode: e, FILLING_CHAR_SEQUENCE: y });
        CKEDITOR.dom.selection.prototype = {
            ...
            getType: m ? function() { var a = this._.cache; if (a.type) return a.type; var b = CKEDITOR.SELECTION_NONE; try { var c = this.getNative(),
            ...
            getRanges: function() {
                var a = m ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        for (; 0 < h;) try { g = f[0 < m ? "previousSibling" : "nextSibling"], g.nodeType == CKEDITOR.NODE_TEXT && (h -= g.nodeValue.length, p = g), f = g } catch (u) { return { container: d, offset: a(f) } }
                ...
                return function(b) { var c = this._.cache,
                        d = c.ranges;
                    d || (c.ranges = d = new CKEDITOR.dom.rangeList(a.call(this))); return b ? r(new CKEDITOR.dom.rangeList(d.slice())) : d }
            }(),
            ...
            getSelectedElement: function() {
                ...
                var b = this,
                    c = CKEDITOR.tools.tryThese(function() { return b.getNative().createRange().item(0) }, function() { for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && N[c.getName()] && (d = c)); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT); return d && d.$ });
            ...
            selectRanges: function(a) {
                ...
                if (a.length)
                    if (this.isLocked) { var k = CKEDITOR.document.getActive();
                        ...
                        if (n) this.fake(n);
                        else if (b && b.plugins.tableselection && b.plugins.tableselection.isSupportedEnvironment() && d(a) && !E && !a[0]._getTableElement({ table: 1 }).hasAttribute("data-cke-tableselection-ignored")) f.call(this, a);
                        else {
                            if (m) {
                                ...
                                a = b.collapsed;
                                var F, p, A;
                                if ((c = b.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in N && (!c.is("a") || !c.getText())) try { A = c.$.createControlRange();
                                    A.addElement(c.$);
                                    A.select(); return } catch (r) {}
                                ...
                                for (A = 0; A < a.length; A++) {
                                    if (A < a.length - 1 && (F = a[A], p = a[A + 1], n = F.clone(), n.setStart(F.endContainer, F.endOffset), n.setEnd(p.startContainer, p.startOffset), !n.collapsed && (n.shrink(CKEDITOR.NODE_ELEMENT, !0), b = n.getCommonAncestor(), n = n.getEnclosedNode(),
                                            b.isReadOnly() || n && n.isReadOnly()))) { p.setStart(F.startContainer, F.startOffset);
                                        a.splice(A--, 1); continue }
                                    b = a[A];
                                    ...
                                    try { p.setEnd(b.endContainer.$, b.endOffset) } catch (t) {
                                        if (0 <=
            ...
            removeAllRanges: function() { if (this.getType() != CKEDITOR.SELECTION_NONE) { var a = this.getNative(); try { a && a[m ? "empty" : "removeAllRanges"]() } catch (b) {}
                    this.reset() } }
        }
    })();
    "use strict";
    ...
    (function() {
        ...
        function b(c) {
            ...
            if (c.collapsed) e = M(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END);
                ...
                var q = c.createBookmark(),
                    ...
                    t = u,
                    x;
                if (!l) { var v = c.getCommonAncestor(),
                        l = a(u, v),
                        v = a(r, v);
                ...
                for (t.getPosition(r) == CKEDITOR.POSITION_FOLLOWING && (t = 0); t;) {
                    ...
                    if (t.equals(r)) t = null, l = !0;
                        ...
                        if (z && t.data("cke-bookmark") || t.type === CKEDITOR.NODE_COMMENT) { t = t.getNextSourceNode(!0); continue }
                        if (v && m && CKEDITOR.dtd.$block[z])
                            for (var D = t, B = f(D), C = void 0, E = B.length, G = 0, D = E && new CKEDITOR.dom.range(D.getDocument()); G < E; ++G) { var C = B[G],
                                    J = CKEDITOR.filter.instances[C.data("cke-filter")]; if (J ? J.check(this) : 1) D.selectNodeContents(C), b.call(this, D) }
                        B = z ? !p[z] || y ? 0 : v && !m ? 0 : d(t, r, h, Q) : 1;
                        if (B)
                            if (C = t.getParent(), B = h, E = g, G = k, !C || !(C.getDtd() || CKEDITOR.dtd.span)[E] && !G || B.parentRule &&
                                !B.parentRule(C)) l = !0;
                            else { if (x || z && CKEDITOR.dtd.$removeEmpty[z] && (t.getPosition(r) | Q) != Q || (x = c.clone(), x.setStartBefore(t)), z = t.type, z == CKEDITOR.NODE_TEXT || v || z == CKEDITOR.NODE_ELEMENT && !t.getChildCount()) { for (var z = t, N;
        ...
        function c(a) {
            ...
            if (a.collapsed) {
                for (var f = new CKEDITOR.dom.elementPath(d.getParent(), a.root), g, h = 0, k; h < f.elements.length && (k = f.elements[h]) && k != f.block && k != f.blockLimit; h++)
                    if (this.checkElementRemovable(k)) { var l;!e && a.collapsed && (a.checkBoundaryOfElement(k, CKEDITOR.END) || (l = a.checkBoundaryOfElement(k, CKEDITOR.START))) ? (g = k, g.match = l ? "start" : "end") : (k.mergeSiblings(), k.is(this.element) ? z.call(this, k) : r(k, E(this)[k.getName()])) }
                if (g) {
                    e =
                        d;
                    for (h = 0;; h++) { k = f.elements[h]; if (k.equals(g)) break;
                    ...
                    p = this;
                b(); for (f = d; !f.equals(m);) g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? z.call(this, f) : r(f, E(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(), g = d.getNext())), f = g }
            a.moveToBookmark(c);
        ...
        function g(a) { var b = a.createBookmark(!0),
            ...
            this._.enterMode && (c.enlargeBr = this._.enterMode != CKEDITOR.ENTER_BR); for (var d, e = a.document, f; d = c.getNextParagraph();) !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = M(this, e, d), u(d, f));
            a.moveToBookmark(b) }
        ...
        function I(a) { for (var b = E(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) d = c.getItem(e), d.isReadOnly() || z.call(this, d, !0); for (var f in b)
                if (f != this.element)
        ...
        function m(a, b) {
            if (!a.hasAttributes() || b)
                if (CKEDITOR.dtd.$block[a.getName()]) { var c = a.getPrevious(v),
                        d = a.getNext(v);!c || c.type != CKEDITOR.NODE_TEXT && c.isBlockBoundary({ br: 1 }) || a.append("br", 1);!d || d.type != CKEDITOR.NODE_TEXT && d.isBlockBoundary({ br: 1 }) || a.append("br");
        ...
        function J(a, b) { for (var c in a) a[c] = a[c].replace(C, function(a, c) { return b[c] }) }
        ...
        var B = { address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1 },
            N = { a: 1, blockquote: 1, embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1, dt: 1, dd: 1, form: 1, audio: 1, video: 1 },
            q = /\s*(?:;\s*|$)/,
            C = /#\((.+?)\)/g,
        ...
        CKEDITOR.style.prototype = {
            apply: function(a) { if (a instanceof CKEDITOR.dom.document) return G.call(this, a.getSelection()); if (this.checkApplicable(a.elementPath(), a)) { var b = this._.enterMode;
            ...
            removeFromRange: function(a) { this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ? l : this.type == CKEDITOR.STYLE_OBJECT ? k : null; return this.removeFromRange(a) },
            ...
            checkElementMatch: function(a, b) {
                ...
                if ("string" == typeof this.element ? d == this.element : d in this.element) {
                    ...
                    if (c._length) { for (var h in c)
                            if ("_length" != h)
                                if (d = a.getAttribute(h) || "", "style" == h ? D(c[h], d) : c[h] == d) { if (!b) return !0 } else if (b) return !1; if (b) return !0 } else return !0
                }
                return !1
            },
    ...
    (function() { if (window.Promise) CKEDITOR.tools.promise = Promise;
        else { var a = CKEDITOR.getUrl("vendor/promise.js"); if ("function" === typeof window.define && window.define.amd && "function" === typeof window.require) return window.require([a], function(a) { CKEDITOR.tools.promise = a });
    ...
    (function() {
        function a(a, f, h) { a.once("selectionCheck", function(a) { if (!d) { var c = a.data.getRanges()[0];
                    h.equals(c) ? a.cancel() : f.equals(c) && (b = !0) } }, null, null, -1) }
        var d = !0,
            b = !1;
        CKEDITOR.dom.selection.setupEditorOptimization = function(a) {
            a.on("selectionCheck", function(a) { a.data && !b && a.data.optimizeInElementEnds();
                b = !1 });
        ...
        CKEDITOR.dom.selection.prototype.optimizeInElementEnds = function() {
            ...
            else { h = b.startContainer.type === CKEDITOR.NODE_TEXT; var k = b.endContainer.type === CKEDITOR.NODE_TEXT,
                    g = h ? b.startContainer.getLength() : b.startContainer.getChildCount();
                h = b.startOffset === g || h ^ k }
            h && (h = b.clone(), b.shrink(CKEDITOR.SHRINK_TEXT, !1, { skipBogus: !0 }), d = !1, a(f, b, h), b.select(), d = !0)
        }
    })();
        ...
        CKEDITOR.dom.elementPath = function(b, f) {
            ...
            do
                if (l.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (l.equals(f)) break;
                    if (!k && (u = l.getName(),
                            "true" == l.getAttribute("contenteditable") ? k = l : !h && d[u] && (h = l), a[u])) { if (u = !h && "div" == u) { a: { u = l.getChildren(); for (var e = 0, x = u.count(); e < x; e++) { var t = u.getItem(e); if (t.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[t.getName()]) { u = !0; break a } }
                                u = !1 }
                            u = !u }
                        u ? h = l : k = l }
                }
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
        ...
        isEmpty: function(a) { var d = this.getText();
            a && (d = CKEDITOR.tools.trim(d)); return !d || d === CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE },
        split: function(a) {
    ...
    */
    ...
    CKEDITOR.plugins.add("dialogui", {
        onLoad: function() {
            ...
            CKEDITOR.ui.dialog.checkbox.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.uiElement, {
                ...
                eventProcessors: {
                    onChange: function(b,
                        a) { if (!CKEDITOR.env.ie || 8 < CKEDITOR.env.version) return v.onChange.apply(this, arguments);
    ...
    (function() {
        ...
        function K(a, b) { for (var c = a.$.getElementsByTagName("input"), d = 0, e = c.length; d < e; d++) { var f = new CKEDITOR.dom.element(c[d]); "text" == f.getAttribute("type").toLowerCase() && (b ? (f.setAttribute("value", f.getCustomData("fake_value") || ""), f.removeCustomData("fake_value")) : (f.setCustomData("fake_value", f.getAttribute("value")), f.setAttribute("value", ""))) } }
        ...
        function X() { var a = this.getInputElement();
            a && a.removeAttribute("aria-invalid") }

        function Y(a) {
            var b = CKEDITOR.dom.element.createFromHtml(CKEDITOR.addTemplate("dialog", Z).output({ id: CKEDITOR.tools.getNextNumber(), editorId: a.id, langDir: a.lang.dir, langCode: a.langCode, editorDialogClass: "cke_editor_" + a.name.replace(/\./g, "\\.") + "_dialog", closeTitle: a.lang.common.close, hidpi: CKEDITOR.env.hidpi ? "cke_hidpi" : "" })),
        ...
        function M(a, b) { this.dialog = a; for (var c = b.contents, d = 0, e; e = c[d]; d++) c[d] = e && new N(a, e);
            CKEDITOR.tools.extend(this, b) }

        function N(a, b) { this._ = { dialog: a };
            CKEDITOR.tools.extend(this, b) }
        ...
        function ba(a) {
            ...
            a.parts.title.on("mousedown", function(g) { if (!a._.moved) { var f = a._.element;
            ...
            if (e != CKEDITOR.DIALOG_RESIZE_NONE) {
                var f =
                    ...
                    g, h, p, m, k, q, l = CKEDITOR.tools.addFunction(function(e) {
                        function d(a) { return a.isVisible() }
                        k = a.getSize();
        ...
        function J(a) { a.data.preventDefault(1) }
        ...
        function Q(a) { CKEDITOR.document.getBody().removeClass("cke_dialog_open");
        ...
        function S(a) { var b = a.data.$.ctrlKey || a.data.$.metaKey,
                c = a.data.$.altKey,
                d = a.data.$.shiftKey,
                e = String.fromCharCode(a.data.$.keyCode);
        ...
        function da(a) { for (var b in x) { for (var c = x[b], d = c.length - 1; 0 <= d; d--) c[d].dialog != a && c[d].uiElement != a || c.splice(d, 1);
                0 === c.length && delete x[b] } }

        function ea(a, b) { a._.accessKeyMap[b] && a.selectPage(a._.accessKeyMap[b]) }
        ...
        CKEDITOR.dialog = function(a, b) {
            function c() { var a = n._.focusList;
            ...
            if (g.onOk) this.on("ok",
                function(b) { a.fire("saveSnapshot");
            ...
            var n = this,
                t = function(a) { var b = n._.contents,
                        c = !1,
                        d; for (d in b)
                        for (var e in b[d])
            ...
            this.on("hide", function() { B.removeListener("keydown", e);
                CKEDITOR.env.gecko && B.removeListener("keypress", f);
                t(function(a) { X.apply(a) }) });
        ...
        CKEDITOR.dialog.prototype = {
            ...
            resize: function(a, b) {
                if (!this._.contentSize || this._.contentSize.width != a || this._.contentSize.height != b) {
                    ...
                    if ("rtl" == this._.editor.lang.dir && this._.position) { var c = this.parts.dialog.getParent().getClientSize().width;
            ...
            layout: function() {
                var a =
                    this.parts.dialog;
                if (this._.moved || !F) { var b = this.getSize(),
            ...
            hide: function() {
                if (this.parts.dialog.isVisible()) {
                    ...
                    if (CKEDITOR.dialog._.currentTop = this._.parentDialog) CKEDITOR.dialog._.currentZIndex -=
                        ...
                        a.removeListener("keyup", S); var c = this._.editor;
                        c.focus();
        ...
        var G = function(a, b, c) { for (var d = 0, e; e = a[d]; d++)
                    if (e.id == b || c && e[c] && (e = G(e[c], b, c))) return e;
                return null },
            H = function(a, b, c, d, e) { if (c) { for (var f = 0, g; g = a[f]; f++) { if (g.id == c) return a.splice(f, 0, b), b; if (d && g[d] && (g = H(g[d], b, c, d, !0))) return g } if (e) return null }
                a.push(b); return b },
            I = function(a, b, c) {
        ...
        M.prototype = { getContents: function(a) { return G(this.contents, a) }, getButton: function(a) { return G(this.buttons, a) }, addContents: function(a, b) { return H(this.contents, a, b) }, addButton: function(a, b) { return H(this.buttons, a, b) }, removeContents: function(a) { I(this.contents, a) }, removeButton: function(a) { I(this.buttons, a) } };
        N.prototype = {
            get: function(a) { return G(this.elements, a, "children") },
            add: function(a, b) { return H(this.elements, a, b, "children") },
            remove: function(a) {
                I(this.elements, a,
                    "children")
            }
        ...
        (function() {
            var a = {
                build: function(a, c, d) {
                    for (var e = c.children, f, g = [], h = [], p = 0; p < e.length && (f = e[p]); p++) { var m = [];
                        g.push(m);
        ...
        (function() {
            ...
            CKEDITOR.on("instanceDestroyed", function(a) { if (CKEDITOR.tools.isEmpty(CKEDITOR.instances)) { for (var b; b = CKEDITOR.dialog._.currentTop;) b.hide(); for (var c in D) D[c].remove();
                    D = {} }
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            openDialog: function(a, b, c) {
                ...
                if (d) d.once("hide", function() { d.setModel(null) }, null, null, 999);
                return d
            }
        })
    })();
    var stylesLoaded = !1;
    CKEDITOR.plugins.add("dialog", { requires: "dialogui", init: function(z) { stylesLoaded || (CKEDITOR.document.appendStyleSheet(this.path + "styles/dialog.css"), stylesLoaded = !0);
            z.on("doubleclick", function(A) { A.data.dialog && z.openDialog(A.data.dialog) }, null, null, 999) } });
        ...
        CKEDITOR.ui.button.prototype = {
            render: function(a, b) {
                ...
                var e = { id: r, button: this, editor: a, focus: function() { CKEDITOR.document.getById(r).focus() }, execute: function() { this.button.click(a) }, attach: function(a) { this.button.attach(a) } },
                    ...
                    u = 0;
                e.clickFn = k = CKEDITOR.tools.addFunction(function() { u && (a.unlockSelection(1), u = 0);
                    e.execute();
                    q.iOS && a.focus() });
                ...
                if (this.directional) a.on("contentDirChanged", function(b) { var c = CKEDITOR.document.getById(this._.id),
                    ...
                    d.setAttribute("style", CKEDITOR.skin.getIconStyle(n, "rtl" == b, this.icon, this.iconOffset)) }, this);
    ...
    (function() {
        ...
        function x(a) {
            ...
            function c(b) { return { type: b, canUndo: "cut" == b, startDisabled: !0, fakeKeystroke: "cut" == b ? CKEDITOR.CTRL + 88 : CKEDITOR.CTRL + 67, exec: function() { "cut" == this.type && g(); var b; var c = this.type; if (CKEDITOR.env.ie) b = e(c);
            ...
            function d() {
                return {
                    ...
                    exec: function(a, b) {
                        function c(b, g) { g = "undefined" !== typeof g ? g : !0;
            ...
            function t() { if ("paste" == p.mainPasteEvent) return a.fire("beforePaste", { type: "auto", method: "paste" }), !1;
                a.focus();
                f(); var b = a.focusManager;
            ...
            function u() { if ("wysiwyg" == a.mode) { var b = q("paste");
            ...
            (function() {
                ...
                if (a.contextMenu) { a.contextMenu.addListener(function() { return { cut: q("cut"), copy: q("copy"), paste: q("paste") } }); var c = null;
                ...
                if (a.ui.addButton) a.once("instanceReady",
                    function() { a._.pasteButtons && CKEDITOR.tools.array.forEach(a._.pasteButtons, function(b) { if (b = a.ui.get(b))
                                if (b = CKEDITOR.document.getById(b._.id)) b.on("touchend", function() { a._.forcePasteDialog = !0 }) }) })
            })();
            (function() {
                function b(c, e, d, g, m) { var k = a.lang.clipboard[e];
                    a.addCommand(e, d);
            ...
            a.getClipboardData = function(b, c) {
                ...
                a.on("beforePaste", function(a) { a.removeListener();
                    g = !0;
                    m = a.data.type }, null, null, 1E3);
                a.on("paste", e, null, null, 0);
                !1 === t() && (a.removeListener("paste", e), a._.forcePasteDialog &&
                    g && a.fire("pasteDialog") ? (a.on("pasteDialogCommit", d), a.on("dialogHide", function(a) { a.removeListener();
        ...
        function C(a) { a.data.preventDefault();
        ...
        function D(a) {
            ...
            a.on("contentDom", function() {
                ...
                function f(b, c, e) { var d = { $: b.data.$, target: b.data.getTarget() };
                    c && (d.dragRange = c);
                ...
                e.attachListener(g, "drop", function(c) { if (!c.data.$.defaultPrevented && (c.data.preventDefault(), !a.readOnly)) { var e = c.data.getTarget(); if (!e.isReadOnly() || e.type == CKEDITOR.NODE_ELEMENT && e.is("html")) { var e = b.getRangeAtDropPosition(c, a),
                                d = b.dragRange;
                            e && f(c, d, e) } } }, null, null, 9999);
        ...
        CKEDITOR.plugins.add("clipboard", {
            ...
            init: function(a) {
                function b(a) { if (!a || h === a.id) return !1; var b = a.getTypes(),
                        b = 1 === b.length && "Files" === b[0];
                    a = 1 === a.getFilesCount(); return b && a }
                var c, d = B(a);
                ...
                if (CKEDITOR.env.gecko) {
                    ...
                    a.on("paste", function(c) {
                        ...
                        if (!d.dataValue && "paste" == d.method && b(l) && (l = l.getFile(0), -1 != CKEDITOR.tools.indexOf(f, l.type))) {
                            ...
                            t.addEventListener("load", function() { c.data.dataValue = '\x3cimg src\x3d"' + t.result + '" /\x3e';
                                a.fire("paste", c.data) }, !1);
                ...
                a.on("paste", function(a) {
                    ...
                    if (b.match(/^<[^<]+cke_(editable|contents)/i)) { var d, f, h = new CKEDITOR.dom.element("div"); for (h.setHtml(b); 1 == h.getChildCount() && (d = h.getFirst()) && d.type == CKEDITOR.NODE_ELEMENT && (d.hasClass("cke_editable") || d.hasClass("cke_contents"));) h = f = d;
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            fixSplitNodesAfterDrop: function(a, b, c, d) {
                function f(a, c, d) { var f = a;
                    f.type == CKEDITOR.NODE_TEXT && (f = a.getParent()); if (f.equals(c) && d != c.getChildCount()) return a = b.startContainer.getChild(b.startOffset - 1), c = b.startContainer.getChild(b.startOffset), a && a.type == CKEDITOR.NODE_TEXT && c && c.type == CKEDITOR.NODE_TEXT && (d = a.getLength(), a.setText(a.getText() + c.getText()), c.remove(), b.setStart(a, d), b.collapse(!0)), !0 }
            ...
            getRangeAtDropPosition: function(a, b) {
                ...
                if (document.caretRangeFromPoint && b.document.$.caretRangeFromPoint(d, f)) c = b.document.$.caretRangeFromPoint(d, f), e.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset),
                    ...
                    if (document.body.createTextRange) {
                        ...
                        try {
                            for (var g = !1, l = 0; 20 > l && !g; l++) { if (!g) try { c.moveToPoint(d, f - l), g = !0 } catch (n) {}
                            ...
                            if (g) {
                                ...
                                u.remove()
                            } else { var q = b.document.$.elementFromPoint(d, f),
                                    p = new CKEDITOR.dom.element(q),
                                    r; if (p.equals(b.editable()) || "html" == p.getName()) return h && h.startContainer && !h.startContainer.equals(b.editable()) ? h : null;
                                r = p.getClientRect();
            ...
            initDragDataTransfer: function(a,
                b) { var c = a.data.$ ? a.data.$.dataTransfer : null,
                    d = new this.dataTransfer(c, b); "dragstart" === a.name && d.storeId();
        ...
        CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
            ...
            isEmpty: function() { var a = {},
                ...
                CKEDITOR.tools.array.forEach(CKEDITOR.tools.object.keys(this._.data), function(b) { a[b] = 1 }); if (this.$)
                    if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported) { if (this.$.types)
                            for (var c = 0; c < this.$.types.length; c++) a[this.$.types[c]] = 1 } else a.Text = 1, a.URL = 1;
                    "Text" != n && (a[n] = 0); for (b in a)
        ...
        CKEDITOR.plugins.clipboard.fallbackDataTransfer.prototype = {
            ...
            getData: function(a, b) { var c = this._getData(this._customDataFallbackType, !0); if (b) return c; var c = this._extractDataComment(c),
                    d = null,
            ...
            _extractDataComment: function(a) { var b = { data: null, content: a || "" }; if (a && 16 < a.length) { var c;
                    (c = /\x3c!--cke-data:(.*?)--\x3e/g.exec(a)) && c[1] && (b.data = JSON.parse(decodeURIComponent(c[1])), b.content = a.replace(c[0], "")) } return b },
            _applyDataComment: function(a, b) { var c = "";
                b && CKEDITOR.tools.object.keys(b).length && (c = "\x3c!--cke-data:" + encodeURIComponent(JSON.stringify(b)) + "--\x3e"); return c + (a && a.length ? a : "") }
        }
    })();
    CKEDITOR.config.clipboard_notificationDuration = 1E4;
    (function() {
        function x(a, e, b) { b = a.config.forceEnterMode || b; if ("wysiwyg" == a.mode) { e || (e = a.activeEnterMode); var l = a.elementPath();
        ...
        CKEDITOR.plugins.add("enterkey", { init: function(a) { a.addCommand("enter", { modes: { wysiwyg: 1 }, editorFocus: !1, exec: function(a) { x(a) } });
        ...
        CKEDITOR.plugins.enterkey = {
            enterBlock: function(a, e, b, l) {
                function n(a) { var b; if (a === CKEDITOR.ENTER_BR || -1 === CKEDITOR.tools.indexOf(["td", "th"], p.lastElement.getName()) || 1 !== p.lastElement.getChildCount()) return !1;
                    a = p.lastElement.getChild(0).clone(!0);
                    (b = a.getBogus()) && b.remove(); return a.getText().length ? !1 : !0 }
                if (b = b || y(a)) {
                    b = z(b);
                    var g = b.document,
    ...
    (function() {
        function k(a, f) { var g = {},
                c = [],
                e = { nbsp: " ", shy: "­", gt: "\x3e", lt: "\x3c", amp: "\x26", apos: "'", quot: '"' };
            a = a.replace(/\b(nbsp|shy|gt|lt|amp|apos|quot)(?:,|$)/g, function(a, b) { var d = f ? "\x26" + b + ";" : e[b];
                g[d] = f ? e[b] : "\x26" + b + ";";
                c.push(d); return "" });
            a = a.replace(/,$/, ""); if (!f && a) { a = a.split(","); var b = document.createElement("div"),
                    d;
                b.innerHTML = "\x26" + a.join(";\x26") + ";";
                d = b.innerHTML;
                b = null; for (b = 0; b < d.length; b++) { var h = d.charAt(b);
                    g[h] = "\x26" + a[b] + ";";
                    c.push(h) } }
    ...
    (function() {
        function m(a) {
            function e(a) { var b = !1;
                g.attachListener(g, "keydown", function() { var d = c.getBody().getElementsByTag(a); if (!b) { for (var f = 0; f < d.count(); f++) d.getItem(f).setCustomData("retain", !0);
                        b = !0 } }, null, null, 1);
        ...
        function n(a) {
            ...
            if (CKEDITOR.env.gecko) try { var c = a.document.$;
                ...
                c.execCommand("enableInlineTableEditing", !1, !a.config.disableNativeTableHandles) } catch (d) {} else CKEDITOR.env.ie && 11 > CKEDITOR.env.version && a.config.disableObjectResizing && e(a)
        }
        ...
        CKEDITOR.editor.prototype.addContentsCss = function(a) { var e = this.config,
                b = e.contentsCss;
    ...
    (function() {
        ...
        function r(c, b) { for (var a = c.plugins.link, e = a.compiledProtectionFunction.params, a = [a.compiledProtectionFunction.name, "("], f, d, g = 0; g < e.length; g++) f = e[g].toLowerCase(), d = b[f], 0 < g && a.push(","), a.push("'", d ? p(encodeURIComponent(b[f])) : "", "'");
        ...
        CKEDITOR.plugins.link = {
            ...
            parseLinkAttributes: function(c, b) {
                ...
                a.match(t) && ("encode" == f ? a = a.replace(A, function(a, b, c) { c = c || ""; return "mailto:" + String.fromCharCode.apply(String, b.split(",")) + c.replace(/\\'/g, "'") }) : f && a.replace(B, function(a,
                    b, c) { if (b == e.name) { d.type = "email";
                        a = d.email = {};
                        b = /(^')|('$)/g;
                        c = c.match(/[^,\s]+/g); for (var f = c.length, g, h, k = 0; k < f; k++) g = decodeURIComponent, h = c[k].replace(b, "").replace(/\\'/g, "'"), h = g(h), g = e.params[k].toLowerCase(), a[g] = h;
            ...
            getLinkAttributes: function(c, b) {
                ...
                if (b.advanced) { for (var l in m)(a = b.advanced[m[l]]) && (e[l] = a);
            ...
            showDisplayTextForElement: function(c,
                b) { var a = { img: 1, table: 1, tbody: 1, thead: 1, tfoot: 1, input: 1, select: 1, textarea: 1 },
                    e = b.getSelection(); return b.widgets && b.widgets.focused || e && 1 < e.getRanges().length ? !1 : !c || !c.getName || !c.is(a) }
        };
        ...
        CKEDITOR.removeAnchorCommand.prototype = { exec: function(c) { var b = c.getSelection(),
                    a = b.createBookmarks(),
                    e; if (b && (e = b.getSelectedElement()) && (e.getChildCount() ? e.is("a") : CKEDITOR.plugins.link.tryRestoreFakeAnchor(c, e))) e.remove(1);
    ...
    (function() {
        function K(a, l, d, f) {
            for (var e = CKEDITOR.plugins.list.listToArray(l.root, d), g = [], b = 0; b < l.contents.length; b++) { var h = l.contents[b];
        ...
        function L(a, l, d) {
            var f = l.contents,
                ...
                g = [];
            if (1 == f.length && f[0].equals(l.root)) { var b = e.createElement("div");
            ...
            for (b = 0; b < f.length; b++)
                for (var c = f[b], p; p = c.getParent();) { if (p.equals(l)) { g.push(c);!k && c.getDirection() && (k = 1);
                        c = c.getDirection(a);
                        null !== h && (h = h && h != c ? null : c); break }
                    c = p }
            if (!(1 > g.length)) {
        ...
        function N(a, l, d) {
            ...
            for (b = h + 1; b < e.length; b++)
                if (e[b].indent > e[b - 1].indent + 1) { g = e[b - 1].indent + 1 - e[b].indent; for (h = e[b].indent; e[b] && e[b].indent >= h;) e[b].indent += g, b++;
                    b-- }
        ...
        CKEDITOR.plugins.list = {
            ...
            arrayToList: function(a, l, d, f, e) {
                ...
                for (var g, b = a[d].parent.getDocument(), h = new CKEDITOR.dom.documentFragment(b), k = null, c = d, p = Math.max(a[d].indent, 0), m =
                    ...
                    if (q.indent == p) { k && a[c].parent.getName() == k.getName() || (k = a[c].parent.clone(!1, 1), e && k.setAttribute("dir", e), h.append(k));
                        m = k.append(q.element.clone(0, 1));
                        n != k.getDirection(1) && m.setAttribute("dir", n); for (g = 0; g < q.contents.length; g++) m.append(q.contents[g].clone(1, 1));
                        c++ } else if (q.indent == Math.max(p, 0) + 1) q = a[c - 1].element.getDirection(1), c = CKEDITOR.plugins.list.arrayToList(a, null, c, f, q != n ? n : null), !m.getChildCount() &&
                        ...
                        for (g = 0; g < z; g++)
                            ...
                            else if (v.type == CKEDITOR.NODE_ELEMENT && v.isBlockBoundary()) { k && !v.getDirection() && v.setAttribute("dir", n);
                            r = v; var A = w.getAttribute("style");
                            A && r.setAttribute("style", A.replace(/([^;])$/, "$1;") + (r.getAttribute("style") || ""));
                            B && v.addClass(B);
                            r = null;
                            x && (m.append(x), x = null);
                            m.append(v.clone(1, 1)) } else J ? (r || (r = b.createElement(y), m.append(r), k && r.setAttribute("dir", n)), E && r.setAttribute("style", E), B && r.setAttribute("class", B), x && (r.append(x), x = null), r.append(v.clone(1,
                ...
                if (l)
                    for (a = h.getFirst(); a;) {
                        if (a.type ==
                            CKEDITOR.NODE_ELEMENT && (CKEDITOR.dom.element.clearMarkers(l, a), a.getName() in CKEDITOR.dtd.$listItem && (d = a, b = e = f = void 0, f = d.getDirection()))) { for (e = d.getParent(); e && !(b = e.getDirection());) e = e.getParent();
        ...
        C.prototype = {
            exec: function(a) {
                ...
                function f(a) { var b = !0; if (0 === a.getChildCount()) return !1;
                ...
                if (this.state == CKEDITOR.TRISTATE_OFF) {
                    var h = a.editable();
                    if (h.getFirst(t)) { var k = 1 == b.length && b[0];
                        (e = k && k.getEnclosedNode()) && e.is && this.type == e.getName() && this.setState(CKEDITOR.TRISTATE_ON) } else e.enterMode ==
                    ...
                    for (k.forceBrBreak =
                        ...
                        if (!m.getCustomData("list_block") && !f(m)) {
                            ...
                            for (var y = a.elementPath(m), n = y.elements, r = 0, y = y.blockLimit, q, w = n.length - 1; 0 <= w && (q = n[w]); w--)
                                if (u[q.getName()] && y.contains(q)) { y.removeCustomData("list_group_object_" + p);
                        ...
                        if (e && e.collapsed) {
                            ...
                            if (b) {
                                ...
                                if (k.range.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), b = (h = f.getLast(t)) && H(h) ? h : f, g = 0, (c = k.next()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in u && c.equals(h) ? (g = 1, c = k.next()) : e.checkBoundaryOfElement(b, CKEDITOR.END) &&
                                    (g = 2), g && c) { e = e.clone();
                                    e.moveToElementEditStart(c); if (1 == g && (d.optimize(), !d.startContainer.equals(f))) { for (f = d.startContainer; f.is(CKEDITOR.dtd.$inline);) p = f, f = f.getParent();
    ...
    (function() {
        ...
        e.prototype = {
            ...
            update: function(a) { if (!this.locked) { a || (a = new f(this.editor)); for (var b = this.index, c = this.snapshots; 0 < b && this.currentImage.equalsContent(c[b - 1]);) --b;
            ...
            lock: function(a, b) { if (this.locked) this.locked.level++;
                ...
                else { var c = null; if (b) c = !0;
                    else { var d = new f(this.editor, !0);
        ...
        f.prototype = {
            ...
            equalsSelection: function(a) { var b = this.bookmarks;
                a = a.bookmarks; if (b || a) { if (!b || !a || b.length != a.length) return !1; for (var c = 0; c < b.length; c++) { var d = b[c],
                            e = a[c]; if (d.startOffset != e.startOffset || d.endOffset != e.endOffset || !CKEDITOR.tools.arrayCompare(d.start, e.start) || !CKEDITOR.tools.arrayCompare(d.end, e.end)) return !1 } } return !0 }
        };
        ...
        k.prototype = {
            onKeydown: function(a) { var b = a.data.getKey(); if (229 !== b)
